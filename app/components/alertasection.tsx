...
export default function AlertaSection() {
  ...
  const buttons = [
    {
      label: "Como agir em caso de enchente",
      icon: "/icons/alertacircular.svg",
      link: "/info#info",
    },
    {
      label: "Reportar Alagamento / Incidente",
      icon: "/icons/alertaincolor.svg",
      link: "/info#alagamento",
    },
    {
      label: "Quero Ajudar",
      icon: "/icons/suporte.svg",
      link: "/info#ajudar",
    },
    {
      label: "Ver rotas de fuga e abrigos",
      icon: "/icons/rota.svg",
      link: "/info#rotas-fuga",
    },
  ];
    ...
    <section className="relative max-w-6xl mx-auto bg-white/80 p-6 rounded-2xl shadow-md flex flex-col gap-6">
      <div className="relative">
        <div className="flex items-center gap-2 text-black font-semibold pr-72">
          <img
            src="/icons/alertaAmarelo.gif"
            alt="check icon"
            className="w-8 h-8"
          />
          <h2>
            <strong>ALERTA AMARELO:</strong> Atenção, condições favoráveis para
            enchentes.
          </h2>
        </div>
        ...
        <div className="absolute top-0 right-0 flex flex-col w-72 h-[312px] justify-between">
          {buttons.map((item) => (
            <NavLink
              className="bg-none shadow-md hover:shadow-lg text-black px-6 py-3 cursor-pointer rounded-xl transition-all w-full text-left flex items-center justify-between gap-3"
              to={item.link}
            >
        ...
        <div className="absolute right-0 mt-[340px] w-72">
          ...
          >
            <img
              src="/icons/medidoralerta.svg"
              alt="Mais Informações icon"
              className="w-50 h-20 mb-1"
            />
      ...
      >
        ...
        <p>
          ...
          <strong> Medida de Segurança: </strong>Manter-se informado e
          preparado.
        </p>
        ...
        <p>
          ...
          <strong> Medida de Segurança: </strong> Revisar planos de emergência e
        ...
        <p>
          ...
          <strong> Medida de Segurança: </strong> Evitar áreas de risco e seguir
        ...
        <p>
          ...
          <strong> Medida de Segurança: </strong>Evacuar áreas de risco e buscar
          abrigo seguro.
        </p>
      </div>
    </section>
